...
from utils.inference import get_suffix, crop_img, predict_68pts, \
    draw_landmarks, predict_dense, get_colors, write_obj_with_colors, predict_pose, draw_axis
import argparse
...
def main(args):
    ...
    checkpoint_fp = 'models/**S1S2_woGeo_best.pth.tar' 
